/* Membership Data edit Janice*/
  
 
 
 window.editaddBusinessDetails=function () {
   var company =  $("#edituserCompany").val();  	
   var year =  $("#editdataYear").val();
   var colNames = [];
   var colValues = [];
   
   var monthRange = document.getElementById("editgetMonthRange");
