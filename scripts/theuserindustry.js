//Gurmeet Singh
window.checkuserindustry=function () {
      ...
      $.post("scripts/database/industryuserselect.php", registerUser, function(data){
      // Change the data from plain text that PHP echo'd to a JavaScript object
      data = JSON.parse(data);
      var p = document.getElementById("theuserindustry");
	  ...
	  window.location.href = "#UserIndustryReport";
