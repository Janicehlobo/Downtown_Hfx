//Gurmeet Singh
window.checkuserprovince=function () {
     ...
     $.post("scripts/database/provinceuserselect.php", registerUser, function(data){
      // Change the data from plain text that PHP echo'd to a JavaScript object
      data = JSON.parse(data);
      var p = document.getElementById("theuserprovince");
	  ...
	  window.location.href = "#UserProvinceReport";
