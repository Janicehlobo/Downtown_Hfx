...
$(document).ready(function() {
    var link = $("#userprovince");
    $("#userprovincelink").on("click", function() {
	$.post("scripts/database/provinceuserselectcsv.php", null, function(data){
      // Change the data from plain text that PHP echo'd to a JavaScript object
		...
		link.attr("download" ,"user-province.csv");
        link[0].click();
    });
	});
	})