...
try {
  ...
  session_start();
   ...
   if($_POST){
    ...
    $sql  = "INSERT INTO dropdowntable (dropdownName,dropdownValue,createdAt,createdBy,dstatus) values ('Category',:CategoryValue, :createdate , :userid ,'Active')" ;

  
   $stmt = $conn->prepare($sql);
   $stmt->execute(array('CategoryValue' => $CategoryValue , 'createdate' => $createdate , 'userid' => $userid  ));
