...
try {
	...
	if (isset($_SESSION["userlogin"])){
		...
		$_SESSION['fyearui']= $_POST['fromyearui'];
		$_SESSION['tyearui']=$_POST['toyearui'];
	  }
	
    $sql = ("SELECT cooptable.industry, cooptable.language, datatable.year, datatable.assetSize, datatable.revenueSize, kpitable.title, kpivalue.kpiValue 
