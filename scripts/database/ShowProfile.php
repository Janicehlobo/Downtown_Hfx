...
try {
   ...
   $sql = ("SELECT idcoop, coopName, industry, type, postalCode, province, country, language 
     from cooptable, access where access.user_iduser='$userid' AND access.cooptable_idcoop=cooptable.idcoop" );
