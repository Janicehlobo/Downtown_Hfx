...
try {
   ...
   if($_POST){
    ...
    $RevenueValue = $_POST['revenueValue'];       
    $createdate = date('Y-m-d');
    $sql  = "INSERT INTO dropdowntable (dropdownName,dropdownValue,createdAt,createdBy,dstatus) values ('RevenueSize', :RevenueValue , :createdate , :userid ,'Active')" ;
  
   $stmt = $conn->prepare($sql);
   $stmt->execute(array('RevenueValue' => $RevenueValue , 'createdate' => $createdate , 'userid' => $userid));
