...
try {
	...
	if (isset($_SESSION["userlogin"])){
		...
		$_SESSION['fyearup']=$_POST['fromyearup'];
		$_SESSION['tyearup']=$_POST['toyearup'];
	  }
	
    $sql = ("SELECT cooptable.industry, cooptable.province, cooptable.language, datatable.year, datatable.assetSize, datatable.revenueSize, kpitable.title, kpivalue.kpiValue 
